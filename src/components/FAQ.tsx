...
const FAQ = () => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-full max-w-md rounded-xl border border-pink-100 shadow-xl bg-white/95 backdrop-blur-sm">
        <DialogHeader className="mb-4">
          <DialogTitle className="text-center text-2xl bg-gradient-to-r from-pink-600 to-pink-800 bg-clip-text text-transparent font-bold">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-pink-100">
            <AccordionTrigger className="font-semibold text-pink-800 hover:text-pink-600 hover:no-underline">
