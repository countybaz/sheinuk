...
const StartScreen = () => {
  ...
  return (
    <div className="max-w-md mx-auto">
      <SurveyHeader title="Great news! You are among the first to join our Shein UK Review Scheme!" />
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <p className="text-center mb-6">
          Ready to take your fashion shopping to the next level? Click the <span className="text-green-600 font-semibold">Start</span> button below
        </p>
      ...
      <div className={`${isMobile ? "sticky bottom-4 z-20" : ""}`}>
        <Button 
          ...
          className={`w-full py-6 text-lg transition-all duration-300 ${
            isMobile 
              ? 'bg-green-500 hover:bg-green-600 shadow-lg text-white font-bold tracking-wider uppercase border-2 border-white' 
